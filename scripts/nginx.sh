...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="brandexpert"
...
sudo cp "/home/$PROJECT_MAIN_DIR_NAME/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
